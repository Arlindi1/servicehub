    ...
    <AppLayout>
        <template #header>
            <div class="flex flex-wrap items-center justify-between gap-3">
                ...
                <Link v-if="can.create" :href="route('app.invoices.create')">
                    <PrimaryButton>
                        New Invoice
                    </PrimaryButton>
                </Link>
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    ...
                    <div class="p-6">
                        <div v-if="invoices.data.length === 0" class="text-center">
                            <div class="text-gray-900">No invoices found.</div>
                            <div class="mt-2 text-sm text-gray-600">
                                Create your first invoice to track billing and delivery.
                            </div>
                            <div class="mt-4" v-if="can.create">
                                <Link :href="route('app.invoices.create')">
                                    <PrimaryButton>
                                        New Invoice
                                    </PrimaryButton>
                                </Link>
